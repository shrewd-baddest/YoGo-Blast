...
export const productDetails=async({params}) => {
  ...
  try{
  const response=  await axios.post('http://localhost/npm/display.php',p_id,{withCredentials:true,});
    if(response.data){
...
export const cart=async()=>{
  ...
  try{
   ...
   const number=await fetch('http://localhost/npm/cart.php',{Credential:included,});
  return number.json();
  }
  catch(error){
    console.log(error);
