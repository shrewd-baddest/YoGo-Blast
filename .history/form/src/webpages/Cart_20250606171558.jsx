...
if (blurs.current){
  ...
  try {
    ...
    const response=await axios.post('http://localhost/npm/order.php',{  productId:id ,quantity: quantity}, {credentials: 'include'});
    ...
    setNumber('254'); // Clear the phone number input after payment
      }
  }
